...
public partial class RegisterPage : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string qry = "insert into [Member] (FirstName, LastName, MailAddress, PhoneNumber, SchoolID, Password) values  ('" + txtName.Text + "', '" + txtLastName.Text + "', '" + txtMailAdress.Text + "', '" + txtPhoneNumber.Text + "' , '" + SchoolID.Text + "', '" + txtPassword.Text + "')";
