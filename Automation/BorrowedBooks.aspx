<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BorrowedBooks.aspx.cs" Inherits="BorrowedBooks" %>
...
<body>
    ...
    <div class="container1"> 
        ...
        <div class="gridBox"> 
                <asp:GridView ID="datagrid" runat="server" autogeneratecolumns="false" CssClass="mydatagrid" HeaderStyle-CssClass="headerGrid" AlternatingRowStyle-CssClass="alt" GridLines="None" RowStyle-CssClass="rows" >
                    <columns>
